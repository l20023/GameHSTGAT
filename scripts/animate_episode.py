...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--episode-seed", type=int, default=4242, help="Seed for the animated test episode.")
    parser.add_argument("--output", type=Path, default=Path("artifacts/animations/episode_demo.gif"))
...
def main() -> None:
    ...
    output_path = save_episode_animation(
        trace,
        nx_graph,
        args.output,
